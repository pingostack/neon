...
func NewProducer(transport *transport.Transport) (*Producer, error) {
	p := &Producer{
		Transport: transport,
	...
	if err := p.validate(); err != nil {
		return nil, errors.Wrap(err, "invalid producer")
	}
...
func (p *Producer) GatheringTracks(gatherAudioTrack, gatherVideoTrack bool, timeout time.Duration) ([]*TrackRemote, error) {
